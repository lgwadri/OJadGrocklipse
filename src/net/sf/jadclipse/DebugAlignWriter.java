...
/**
 * Aligns the content of the stream according to Jad line number
 * comments by inserting new line characters. Neighbor lines with
 * the same number are collapsed into one line. Lines that are out
 * of oder are commented as MISALIGNED. All line comments are removed
 * from the stream, block comments left intact. Original empty lines
 * are also removed to improve chances of successful alignment
 * 
...
public class DebugAlignWriter extends Writer
{
	...
	/**
	 * Writes whatever is left in internal buffer to the underlying writer,
	 ...
	 * 
	 * @return target line number or -1 if this line doesn't need to be
	 * aligned
	 */
